...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(type, count) => "${type}種類の装備を${count}個持っています";

  static String m4(name) => "${name}、到着しました！";

  static String m5(url) => "Now navigation to ${url}";

  static String m6(url) => "ページの読み込みが完了しました: ${url}";

  static String m7(url) => "ページの読み込み開始:${url}";

  static String m8(taskTitle) => "${taskTitle} が完了しました。";

  static String m9(length) => "${length}個のデーターをインポートします。";

  static String m10(statusCode) => "ネットワークエラー発生：${statusCode}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "DataErrorNotice": MessageLookupByLibrary.simpleMessage(
            "データの解析に失敗しました。データに関する機能は正しく動作しません。開発者に連絡してください。また、ネットワークエラーが発生した場合は、リロードしてください。"),
        ...
        "KCAdmiralRank1": MessageLookupByLibrary.simpleMessage("元帥"),
        "KCAdmiralRank10": MessageLookupByLibrary.simpleMessage("新米少佐"),
        ...
        "KCAdmiralRank5": MessageLookupByLibrary.simpleMessage("大佐"),
        "KCAdmiralRank6": MessageLookupByLibrary.simpleMessage("中佐"),
        "KCAdmiralRank7": MessageLookupByLibrary.simpleMessage("新米中佐"),
        "KCAdmiralRank8": MessageLookupByLibrary.simpleMessage("少佐"),
        "KCAdmiralRank9": MessageLookupByLibrary.simpleMessage("中堅少佐"),
        "KCAirBattleDenial": MessageLookupByLibrary.simpleMessage("航空劣勢"),
        "KCAirBattleIncapability":
            MessageLookupByLibrary.simpleMessage("制空権喪失"),
        "KCAirBattleParity": MessageLookupByLibrary.simpleMessage("制空均衡"),
        "KCAirBattleSuperiority": MessageLookupByLibrary.simpleMessage("航空優勢"),
        "KCAirBattleSupremacy": MessageLookupByLibrary.simpleMessage("制空権確保"),
        ...
        "KCBattleContactStatus1": MessageLookupByLibrary.simpleMessage("同航戦"),
        "KCBattleContactStatus2": MessageLookupByLibrary.simpleMessage("反航戦"),
        ...
        "KCBattleFormation1": MessageLookupByLibrary.simpleMessage("単縦陣"),
        ...
        "KCBattleFormation2": MessageLookupByLibrary.simpleMessage("複縦陣"),
        "KCBattleFormation3": MessageLookupByLibrary.simpleMessage("輪形陣"),
        "KCBattleFormation4": MessageLookupByLibrary.simpleMessage("梯形陣"),
        "KCBattleFormation5": MessageLookupByLibrary.simpleMessage("単横陣"),
        "KCBattleFormation6": MessageLookupByLibrary.simpleMessage("警戒陣"),
        ...
        "KCDashboardBattleEnemy": MessageLookupByLibrary.simpleMessage("敵艦隊"),
        "KCDashboardBattleLastChosen": m1,
        "KCDashboardBattleMapStateCleared":
            MessageLookupByLibrary.simpleMessage("攻略済み"),
        "KCDashboardBattleMoreInfo": MessageLookupByLibrary.simpleMessage("詳細"),
        "KCDashboardBattleOur": MessageLookupByLibrary.simpleMessage("味方艦隊"),
        "KCDashboardBattleRecord": MessageLookupByLibrary.simpleMessage("戦績"),
        ...
        "KCEquipmentMainTypeFilterSearchlightAndDevice":
            MessageLookupByLibrary.simpleMessage("探照灯・装備"),
        "KCEquipmentMainTypeFilterTorpedo":
            MessageLookupByLibrary.simpleMessage("魚雷"),
        "KCEquipmentMainTypeFilterVehicle":
            MessageLookupByLibrary.simpleMessage("舟艇・戦車"),
        "KCEquipmentViewerTotalNote": m3,
        "KCFleetCombined": MessageLookupByLibrary.simpleMessage("連合艦隊"),
        "KCFleetCombinedCarrier": MessageLookupByLibrary.simpleMessage("機動部隊"),
        "KCFleetCombinedSurface": MessageLookupByLibrary.simpleMessage("水上部隊"),
        "KCFleetCombinedTransport":
            MessageLookupByLibrary.simpleMessage("輸送部隊"),
        "KCFleetMono": MessageLookupByLibrary.simpleMessage("単艦隊"),
        ...
        "KancolleUseHTTP":
            MessageLookupByLibrary.simpleMessage("KCサーバーにHTTPを使用する"),
        ...
        "TextCategory": MessageLookupByLibrary.simpleMessage("カテゴリ"),
        ...
        "TextOther": MessageLookupByLibrary.simpleMessage("その他"),
        ...
        "TextSort": MessageLookupByLibrary.simpleMessage("並び替え"),
